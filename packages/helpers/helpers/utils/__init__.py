...
class DirPaths:
    ...
    def __init__(self, start: str | Path | None = None, ensure: bool = False, outs: str | None = None) -> None:
...
class Project:
    def __init__(self, path: str, logger: str | None = None, outs: str | None = None) -> None:
